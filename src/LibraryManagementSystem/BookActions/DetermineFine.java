...
public class DetermineFine implements BookActions{
    private static final double FINE_PER_DAY = 1.0; // Gün başına ceza miktarı
    ...
    public void actions(Database database, User user) {
        ...
        for (Book book : borrowedBooks) {
            ...
            if (borrowedDateString != null && !borrowedDateString.isEmpty()) {
                ...
                long remainingDays = 90 - daysBetween;
                ...
                if (daysBetween > 90) { // 90 gün aşılmışsa ceza hesapla
                    ...
                    System.out.println("Kitabı iade etmenize " + remainingDays + " gün kaldı. İade etmezseniz günlük 1 TL ceza uygulanacaktır.");
                }
            } else {
